...
var 	//botones
		...
		divCorrectAnswer= document.getElementById("divCorrectAnswer"),
		ePlayerName,
...
//funciones de botones
	...
	}, false)//fin btnPlayerName


	function callShake() {

		var inputNode = document.querySelectorAll(".leftContent [name='tema']");

		inputNode[0].classList.add("shake");
...
*/
		...
		function removeBounceInDown() {

			
			var myNode = document.querySelector("body div"); // Escoje el div principal
			myNode.classList.remove("bounceInDown");
			myNode.classList.add("bounceInUp");
...
*/
	...
	function changeBackground() {
		...
		htmlNode.style.background = "url('../proyectoFinalFinal/images/NH1nLsV.png')";
		htmlNode.style.backgroundRepeat = "repeat-x repeat-y";

		mainNode.style.background = "rgba(89, 82, 65, .8)"
	...
	}, false)//Fin boton history


	function changeHistoryBackground() {

		var htmlNode = document.querySelector("html");

		htmlNode.style.background = "url('../proyectoFinalFinal/images/LXmxZKh.jpg')";
		htmlNode.style.backgroundRepeat = "repeat-x repeat-y";

		var mainNode = document.querySelector(".main-content");
		mainNode.style.background = "rgba(64, 65, 30, .93)"
	}
	...
	}, false)//Fin BotonGeneral

	function changeBackGen() {
		var htmlNode = document.querySelector("html");

		htmlNode.style.background = "url('../proyectoFinalFinal/images/fOPjgJ8.jpg')";
		htmlNode.style.backgroundRepeat = "repeat-x repeat-y";

		var mainNode = document.querySelector(".main-content");
		mainNode.style.background = "rgba(62, 96, 111, .96)"
	}
	...
	function removeMainContent(){
		...
		bodyNode.style.width = "800px";
		bodyNode.style.margin = "0 auto";
		bodyNode.style.marginTop = "5.202em";
		bodyNode.style.background = "rgba(94, 90, 89, .96)";
		bodyNode.style.padding = "40px 60px";
		bodyNode.style.borderRadius = "20px";
...
//funcion para mostrar la cantidad de preguntas que faltan
	function questCounter (nQuestCounter) {
		...
		ePar.innerHTML= "Jugador: " + ePlayerName + "<br> Preguntas por contestar: " + nQuestCounter + "<br> Respuestas correctas: " + nCorrect + ". <br> Respuestas incorrectas: " + nIncorrect + ".";
	}//fin questCounter
...
//funcion para meter las preguntas y opciones dentro del formulario
	function insertQuestions (pArrQuestUser, index) {  //index viene a ser el numero de pregunta
		...
		formPar[0].innerHTML =  thisQuestArray[0]; 
...
//funcion que controla los botones de respuesta del usuario.
	function questionOperatorButton (pButton, pArrUserQuest) {
		...
		var bodyNode = document.querySelector("body");
			...
			{
				nIncorrect++;
				displayCorrectAnswer (sCorrectAnswer);
...
//funcion para desplegar los resultados finales
	...
	var inicioButton = document.querySelector("#recargar");
...
function displayCorrectAnswer (sCorrectAnswer) {
		var pCorrectAnswer= document.getElementById("pCorrectAnswer");
		
		divCorrectAnswer.style.display="block";
		pCorrectAnswer.innerHTML= "Incorrecto, la respuesta correcta era " + sCorrectAnswer;
		divCorrectAnswer.style.background = "rgba(255, 45, 0, .97)";
    	setTimeout(function(){ divCorrectAnswer.style.display="none"; }, 3000);
				
	}//fin displayCorrectAnswer
	...
	function displayCorrectMsg () {
		...
		divCorrectAnswer.style.display="block";
		divCorrectAnswer.style.background = "rgba(88, 143, 39, .97)";

		pCorrectAnswer.innerHTML= "Correcto!!!";

    	setTimeout(function(){ divCorrectAnswer.style.display="none"; }, 2000);
    }	